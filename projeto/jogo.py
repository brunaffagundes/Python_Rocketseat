# Jogo de combate em turno, teremos herói e inimigo

# Personagem: classe mãe (terá o que é comum entre os personagens)
# Herói: controlado pelo usuário
# Inimigo: adversário contra usuário
